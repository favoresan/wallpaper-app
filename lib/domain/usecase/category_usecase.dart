...
class CategoryUseCase implements BaseUseCase<CategoryUseCaseInput, Images> {
  Repository _repository;
  CategoryUseCase(this._repository);
  @override
  Future<Either<Failure, Images>> execute(CategoryUseCaseInput input) async {
...
class CategoryUseCaseInput {
  String search;
  CategoryUseCaseInput(this.search);
}
